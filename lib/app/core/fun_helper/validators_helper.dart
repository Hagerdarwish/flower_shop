...
import '../values/user_error_messages.dart';
...
class Validators {
  ...
  static String? validatePassword(String? value) {
    ...
    if (value.length < 6) return UserErrorMessages.least6Charachters;
  ...
  static String? validateName(String? value) {
    ...
    if (value.length < 3) {
      return UserErrorMessages.least3Charachters;
    }
    if (RegExp(r'[!@#<>?":_`~;[\]\\|=+)(*&^%-]').hasMatch(value)) {
      return UserErrorMessages.invalidNamed;
    }
    return null;
  }
}