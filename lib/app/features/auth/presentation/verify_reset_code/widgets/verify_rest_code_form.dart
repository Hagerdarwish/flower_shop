        ...
        return SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                LocaleKeys.verification_emailVerification.tr(), // Replace with LocaleKeys.tr()
                style: Theme.of(context).textTheme.headlineMedium,
              ),
              const SizedBox(height: 10),
              Text(
                LocaleKeys.verification_instruction.tr(), // Replace with LocaleKeys.tr()
              ...
              Row(
                ...
                children: [
                  Text(
                    LocaleKeys.verification_didNotReceive.tr(), // Replace with LocaleKeys.tr()
                    style: Theme.of(context).textTheme.headlineSmall,
                  ),
                  const SizedBox(width: 10),
                  CustomActionText(
                    text: LocaleKeys.verification_resend.tr(),
